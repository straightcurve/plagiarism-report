...
export const DEFAULT_TEXT_CONFIG: CopyleaksTextConfig = {
  RESULT_PUSH_ERROR:
    "Unable to retrieve result content at this time. Please try again later.",
  IDENTICAL_TOOLTIP_TEXT:
    "Identical matches are one to one exact wording in the text. Click to disable",
  MINOR_CHANGES_TOOLTIP_TEXT:
    'Nearly identical with different form, ie "slow" becomes "slowly". Click to disable',
  RELATED_MEANING_TOOLTIP_TEXT:
    "Close meaning but different words used to convey the message. Click to disable",
  OMITTED_WORDS_TOOLTIP_TEXT: "Words that have been hidden.",
  MATCH_TYPE_OMITTED_TOOLTIP_TEXT:
    "Omitted by your configuration. Click to enable",
};
...
export const COPYLEAKS_CONFIG_INJECTION_TOKEN =
  new InjectionToken<CopyleaksReportConfig>("copyleaks-config");

/** Injection token used to override the default text messages of the report */
export const COPYLEAKS_TEXT_CONFIG_INJECTION_TOKEN =
  new InjectionToken<CopyleaksTextConfig>("copyleaks-text-config");
