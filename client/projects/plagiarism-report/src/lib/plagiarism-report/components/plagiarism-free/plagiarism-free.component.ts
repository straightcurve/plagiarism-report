...
import {
  CompleteResultNotificationAlertSeverity,
  ResultItem,
} from "../../models";
import {
...
@Component({
  ...
  styleUrls: ["./plagiarism-free.component.sass"],
})
export class PlagiarismFreeComponent implements OnInit {
  ...
  constructor(
    private translateService: CopyleaksTranslateService,
