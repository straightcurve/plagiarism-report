...
export class CopyleaksService {
  ...
  private readonly _config$ = new BehaviorSubject<CopyleaksReportConfig>({
    ...DEFAULT_REPORT_CONFIG,
  });
  ...
  public readonly onResultItems$ = this._results$;
  ...
  public readonly filteredResultsIds$ =
    this._filteredResultsIds$.asObservable();
  ...
  private isCompleteResult = (o: CompleteResult) =>
    o && !!o.scannedDocument && !!o.results;
  private isScanSource = (o: ScanSource) =>
    o && !!o.metadata && !!o.text && !!o.version;
  private isScanResult = (o: ScanResult) =>
    o && !!o.text && !!o.statistics && !!o.version;
  private isNewResult = (o: NewResult) =>
    o && !!o.internet && !!o.database && !!o.batch;
  private isCorrectVersion = (o: ScanResult | ScanSource) =>
    o && o.version === 3;
}
