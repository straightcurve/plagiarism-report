...
@NgModule({
  ...
  providers: [
    {
      provide: COPYLEAKS_CONFIG_INJECTION_TOKEN,
      useValue: { ...DEFAULT_REPORT_CONFIG },
    },
    {
      provide: COPYLEAKS_TEXT_CONFIG_INJECTION_TOKEN,
      useValue: { ...DEFAULT_TEXT_CONFIG },
    },
  ],
  entryComponents: [
    OptionsDialogComponent,
  ...
  static forRoot(
    ...
    return {
      ...
      providers: [
        ...
        {
          provide: COPYLEAKS_CONFIG_INJECTION_TOKEN,
          useValue: { ...DEFAULT_REPORT_CONFIG, ...config },
        },
        {
          provide: COPYLEAKS_TEXT_CONFIG_INJECTION_TOKEN,
          useValue: { ...DEFAULT_TEXT_CONFIG, ...textConfig },
        },
      ],
