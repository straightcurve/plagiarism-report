 ...
 */
export const isCopyleaksReportOptions = (
  ...
  if (options.showIdentical && typeof options.showIdentical !== "boolean") {
    logErrors &&
      console.warn("config.options.showIdentical should be a boolean");
    return false;
  }
  if (
    options.showMinorChanges &&
    typeof options.showMinorChanges !== "boolean"
  ) {
    logErrors &&
      console.warn("config.options.showMinorChanges should be a boolean");
    return false;
  }
  ...
  if (
    options.showOnlyTopResults &&
    typeof options.showOnlyTopResults !== "boolean"
  ) {
    logErrors &&
      console.warn("config.options.showOnlyTopResults should be a boolean");
    return false;
  }
  if (options.showPageSources && typeof options.showPageSources !== "boolean") {
    logErrors &&
      console.warn("config.options.showPageSources should be a boolean");
    return false;
  }
  if (options.setAsDefault && typeof options.setAsDefault !== "boolean") {
    logErrors &&
      console.warn("config.options.setAsDefault should be a boolean");
    return false;
  }
  return true;
};
 ...
 * @param logErrors whether to show errors or not. defaults to false
 */
export const isCopyleaksReportConfig = (
  ...
  if (
    config.disableSuspectBackButton &&
    typeof config.disableSuspectBackButton !== "boolean"
  ) {
    logErrors &&
      console.warn("config.disableSuspectBackButton should be a boolean");
    return false;
  }
  ...
  if (
    ...
    !isCopyleaksReportOptions(config.options, logErrors)
  ) {
    return false;
  }
  if (
    config.suspectId !== undefined &&
    config.suspectId !== null &&
    typeof config.suspectId !== "string"
  ) {
    logErrors && console.warn("config.suspectId should be a string");
    return false;
  }
  if (
    config.scanId !== undefined &&
    config.scanId !== null &&
    typeof config.scanId !== "string"
  ) {
    logErrors && console.warn("config.scanId should be a string");
    return false;
  }
  if (
    config.sourcePage !== undefined &&
    typeof config.sourcePage !== "number"
  ) {
    logErrors && console.warn("config.sourcePage should be a number");
    return false;
  }
  if (
    config.suspectPage !== undefined &&
    typeof config.suspectPage !== "number"
  ) {
